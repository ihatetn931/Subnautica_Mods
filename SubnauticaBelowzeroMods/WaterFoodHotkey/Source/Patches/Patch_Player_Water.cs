...
namespace WaterFoodHotkeyBZ.Patches
{
    public static class PlayerWater_Patch
    {
        public static void Patch_Player_Water()
        {
            ...
            if (Input.GetKeyDown(MainPatch.WaterHotKey) && MainPatch.ToggleWaterHotKey == false && !MainPatch.EditNameCheck)
            {
            ...
            else if (Input.GetKeyDown(MainPatch.WaterHotKey) && MainPatch.ToggleWaterHotKey == true && !MainPatch.EditNameCheck)
            {
