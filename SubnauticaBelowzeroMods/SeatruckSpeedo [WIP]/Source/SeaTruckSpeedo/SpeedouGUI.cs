namespace SeatruckSpeedoBZ
{
    ...
    class BiomeDisplay : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            _thumbnailFlag = MainPatch.imagesEnabled;
            imageAlpha = MainPatch.imageAlpha;
            //_coordsFlag = MainPatch.showCoords;

            _BiomeHUDObject = Instantiate<GameObject>(MainPatch.BiomeHUD);
