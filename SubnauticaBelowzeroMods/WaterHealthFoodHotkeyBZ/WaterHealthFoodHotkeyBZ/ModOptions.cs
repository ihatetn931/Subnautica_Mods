...
namespace WaterHealthFoodHotkeyBZ.Menu
{
    ...
    {
        [Toggle("Toggle Water Hotkey", Id = "ToggleWaterHotKey"), OnChange(nameof(CheckboxToggleEvent))]
        public bool ToggleWater = true;
        [Toggle("Toggle Food Hotkey", Id = "ToggleFoodHotKey"), OnChange(nameof(CheckboxToggleEvent))]
